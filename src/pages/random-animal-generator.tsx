...
const Content = () => {
    ...
    return (
        <>
            <H1Text className='py-8' content="Random Animal Generator" />
...
const Page = () => {
    ...
    return (
        <>
            <Seo hasChat title="Random Animal Generator" description='Generate random animal names using our random animal name generator.' />
