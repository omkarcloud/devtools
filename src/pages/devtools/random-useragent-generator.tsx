...
const Content = () => {
    ...
    return (
        <>
            <H1Text className='py-8' content="Random Useragent Generator" />
                ...
                <div className='space-y-8'>
                    ...
                    <EuiCard title="Output" >
                        <EuiFormRow label="Output" fullWidth>
                            <OutputTextAreaField rows={6} value={output} />
                        </EuiFormRow>
                    </EuiCard>
                </div>
            </div>
...
const Page = ({ is_authenticated }) => {
    ...
    return (
        <>
            <Seo hasChat title="Random Useragent Generator" description='Generate random useragents using our random useragent generator.' />
