...
const Content = () => {
    ...
    return (
        <>
            <H1Text className='py-8' content="Random Product Name Generator" />
...
const Page = () => {
    ...
    return (
        <>
            <Seo hasChat title="Random Product Name Generator" description='Generate random product names using our random product name generator.' />
