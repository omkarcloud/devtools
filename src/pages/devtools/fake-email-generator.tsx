...
const Content = () => {
    ...
    return (
        <>
            <H1Text className='py-8' content="Fake Email Generator" />
...
const Page = ({ is_authenticated }) => {
    ...
    return (
        <>
            <Seo hasChat title="Fake Email Generator" description='Generate fake emails using our fake email generator.' />
