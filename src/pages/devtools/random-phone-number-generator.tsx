...
const Content = () => {
    ...
    return (
        <>
            <H1Text className='py-8' content="Random Phone Number Generator" />
...
const Page = ({ is_authenticated }) => {
    ...
    return (
        <>
            <Seo hasChat title="Random Phone Number Generator" description='Generate random phone number using our random phone number generator.' />
