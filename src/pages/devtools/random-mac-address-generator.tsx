...
const Content = () => {
    ...
    return (
        <>
            <H1Text className='py-8' content="Random Mac Address Generator" />
...
const Page = ({ is_authenticated }) => {
    ...
    return (
        <>
            <Seo hasChat title="Random Mac Address Generator" description='Generate random mac addresses using our random mac address generator.' />
