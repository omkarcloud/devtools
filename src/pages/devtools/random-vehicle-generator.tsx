...
const Content = () => {
    ...
    return (
        <>
            <H1Text className='py-8' content="Random Vehicle Generator" />
...
const Page = () => {
    ...
    return (
        <>
            <Seo hasChat title="Random Vehicle Generator" description='Generate random vehicles using our random vehicles generator.' />
