...
const Content = () => {
    ...
    return (
        <>
            <H1Text className='py-8' content="Random Emoji Generator" />
...
const Page = ({ is_authenticated }) => {
    ...
    return (
        <>
            <Seo hasChat title="Random Emoji Generator" description='Generate random emojis using our random emoji generator.' />
