...
function generateContent() {
    return faker.color.rgb({ prefix: '#', casing: 'lower' }) 
}
...
const Content = () => {
    ...
    return (
        <>
            <H1Text className='py-8' content="Random Color Generator" />
...
const Page = () => {
    ...
    return (
        <>
            <Seo hasChat title="Random Color Generator" description='Generate random colors using random our color generator.' />
