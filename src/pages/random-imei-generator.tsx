...
const Content = () => {
    ...
    return (
        <>
            <H1Text className='py-8' content="Random IMEI Generator" />
...
const Page = () => {
    ...
    return (
        <>
            <Seo hasChat title="Random IMEI Generator" description='Generate random imei using our random imei generator.' />
