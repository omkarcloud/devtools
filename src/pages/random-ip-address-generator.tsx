...
const Content = () => {
    ...
    return (
        <>
            <H1Text className='py-8' content="Random IP Address Generator" />
...
const Page = () => {
    ...
    return (
        <>
            <Seo hasChat title="Random IP Address Generator" description='Generate random ip address using our random ip address generator.' />
